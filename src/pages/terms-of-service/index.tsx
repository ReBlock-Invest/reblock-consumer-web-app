  ...
  return (
    <MainLayout>
      ...
      >
        ...
        <Paragraph>
        Welcome to https://reblock.finance (the “Website”). This Terms of Use Agreement (the “Agreement”) is made and entered into by and between you and Reblock Technology Company (the “Company”, “us”, “we”, or “our”). This Agreement sets forth the terms and conditions that govern your use of and access to the Website and any products, materials, and services provided by or on the Website (collectively, the “Services”).
        </Paragraph>
        <Paragraph>
        1.Acceptance of this Agreement 1.1. Acceptance Through Using or Accessing the Services Please review the following terms carefully. By accessing or using the Services (or by clicking on “accept” or “agree” to this Agreement when prompted), you agree to be bound by the terms and conditions of this Agreement on behalf of yourself or the entity or organization that you represent. If you do not agree to the terms and conditions of this Agreement, you may not use or access the Services and must exit the Website immediately.
        </Paragraph>
        <Paragraph>
        1.2. Eligibility Requirements to Use or Access the Services To use the Website or any other Services, you must be (i) at least 18 years old, and (ii) not a competitor of or using the Services for purposes that are competitive with the Company.
        </Paragraph>
        <Paragraph>
        ...
        <Paragraph>
        12.3. Limitation to Time to File Claims. ANY CAUSE OF ACTION OR CLAIM YOU MAY HAVE ARISING OUT OF OR RELATING TO THIS AGREEMENT OR THE SERVICES MUST BE COMMENCED WITHIN ONE (1) YEAR AFTER THE CAUSE OF ACTION AROSE; OTHERWISE, SUCH CAUSE OF ACTION OR CLAIM IS PERMANENTLY WAIVED AND BARRED.
        </Paragraph>
        <Paragraph>
        13.Miscellaneous 13.1. Waiver Except as otherwise set forth in this Agreement, no failure of the Company to exercise, or delay by the Company in exercising, any right, remedy, power, or privilege arising from this Agreement shall operate or be construed as a waiver thereof, nor shall any single or partial exercise of any right, remedy, power, or privilege hereunder preclude any other or further exercise thereof or the exercise of any other right, remedy, power, or privilege.
        </Paragraph>
        <Paragraph>
        ...
        <Paragraph>
        13.4. Headings Headings and titles of sections, clauses, and parts in this Agreement are for convenience only. Such headings and titles shall not affect the meaning of any provisions of the Agreement.
        </Paragraph>
        <Paragraph>
        13.5. No Agency, Partnership or Joint Venture No agency, partnership, or joint venture has been created between you and the Company as a result of this Agreement. You do not have any authority of any kind to bind the Company in any respect whatsoever.
        </Paragraph>
        <Paragraph>
        13.6. Assignment You shall not assign or delegate any of your rights or obligations under this Agreement without the prior written consent of the Company. Any purported assignment or delegation in violation of this Section shall be deemed null and void. No assignment or delegation shall relieve you of any of your obligations hereunder. The Company may freely assign or delegate its rights and obligations under this Agreement at any time. Subject to the limits on assignment stated above, this Agreement will inure to the benefit of, be binding on, and be enforceable against each of the parties hereto and their respective successors and assigns.
        </Paragraph>
        <Paragraph>
        14.Contact Information All feedback, comments, requests for technical support, and other communications relating to the Services should be directed to admin@reblock.finance.
        </Paragraph>
      </Flex>
    </MainLayout>
  )
